...
/**
 * An exception that is trown if an there was a problem to load a script
 * 
 * @author Asaf Shakarchi
 */
public class ScriptLoadingException extends EdmException{
	...
	public ScriptLoadingException(Throwable t) {
		super(t);
	}
}