...
/**
 * An exception that thrown if a JDBC driver was not found
 * 
 * @author Asaf Shakarchi
 */
public class JdbcDriverNotFoundException extends EdmException{
	 ...
	 */
	public JdbcDriverNotFoundException(String msg) {
		super(msg);
	}
}
