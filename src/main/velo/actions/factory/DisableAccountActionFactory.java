...
public class DisableAccountActionFactory extends AccountActionFactory {
	private final String actionPartialFileName = "disable_account";
	
	private static Logger logger = Logger.getLogger(DisableAccountActionFactory.class.getName());
	
	public DisableAccountActionFactory() {
		
	}
	
	public DisableAccountActionFactory(Account account) throws ActionFactoryException{ 
		super(account.getResource(),account);
	}
	

	/**
	 * Factory a 'disable account' action
	 * 
