...
public class EnableAccountActionFactory extends AccountActionFactory {
	private final String actionPartialFileName = "enable_account";
	private static Logger logger = Logger.getLogger(EnableAccountActionFactory.class.getName());
	
	public EnableAccountActionFactory() {
		
	}
	
	public EnableAccountActionFactory(Account account) throws ActionFactoryException{ 
