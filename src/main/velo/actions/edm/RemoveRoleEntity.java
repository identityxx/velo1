 ...
 */
@Deprecated
public class RemoveRoleEntity extends Action implements ActionInterface {
	private static final long serialVersionUID = 1987305452306161212L;
	private static Logger logger = Logger.getLogger(RemoveRoleEntity.class.getName());
	
	public boolean execute() {
		logger.info("Removing role entity by action");
		...
		try {
			...
			rolem.deleteUserRoleEntity(userRole);
