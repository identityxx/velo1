 ...
 */
public abstract class HttpClientAccountAction extends HttpClientResourceAction implements ResourceAccountActionInterface {
	 ...
	 */
	public HttpClientAccountAction(Resource resource) {
		super(resource);
	}
	 ...
	 */
	public HttpClientAccountAction() {
